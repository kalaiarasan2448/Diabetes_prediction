...
Preg=ttk.Label(win,text="Preg",width=35,font=("algerian", 15))
...
Gluco=ttk.Label(win,text="Glucose",width=35,font=("algerian", 15))
...
Insulin=ttk.Label(win,text="Insulin",width=35,font=("algerian", 15))
...
BMI=ttk.Label(win,text="BMI",width=35,font=("algerian", 15))
...
Pedigreefunc=ttk.Label(win,text="Pedigreefunc",width=35,font=("algerian", 15))
...
Age=ttk.Label(win,text="Age",width=35,font=("algerian", 15))
